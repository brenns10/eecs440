...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_directory', dest='dataset_directory',
                        metavar='DIR', default='.')
    ...
    parser.add_argument('--meta_iters', metavar='N', type=int, required=False,
                        help='Iterations for bagging or boosting,'
                        ' if applicable')
    parser.add_argument('--fs_algorithm', metavar='ALG', required=False,
                        choices=['pca'],
                        help='Feature selection algorithm, if desired')
    parser.add_argument('--fs_features', metavar='N', required=False, type=int,
    ...
    dtree_parser.add_argument('--depth', type=int,
                              help='Maximum depth for decision tree, 0 for '
                              'None', default=2)
    ...
    svm_parser.add_argument('--c', type=float,
                            help='Regularization parameter for SVM', default=1)
    svm_parser.add_argument('--is_linear', type=int,
                            help='whether using linear SVM', default=1)
